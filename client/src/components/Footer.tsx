  ...
  return (
    <div id="footer">
      <div id="footer__buttons">
        <button id="footer__buttons__home">
          <div id="footer__buttons__home__image">
            <svg
          ...
          <div id="footer__buttons__home__name">
            <p>Home</p>
          </div>
        </button>
        <button id="footer__buttons__shorts" disabled>
          ...
          <div id="footer__buttons__shorts__name">
            <p>Shorts</p>
          </div>
        </button>
        <button id="footer__buttons__library" disabled>
          ...
          <div id="footer__buttons__library__name">
            <p>Library</p>
          </div>
        </button>
      </div>
